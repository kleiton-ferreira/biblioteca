...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (loginForm) {
        loginForm.addEventListener('submit', (e) => {
            ...
            if (email === storedEmail && password === storedPassword && role === storedRole) {
                if (storedRole === 'admin') {
                    window.location.href = '../paginas_principais/admin.html';
                } else {
                    window.location.href = '../paginas_principais/usuario.html';
                }
            } else {
    ...
    if (registerForm) {
        registerForm.addEventListener('submit', (e) => {
            ...
            window.location.href = '../biblioteca/registro_login/login.html';
        });
    }
